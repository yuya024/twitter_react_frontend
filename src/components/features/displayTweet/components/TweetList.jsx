          ...
          <Link to={`/tweets/${tweet.id}`} key={tweet.id}>
            <div className="grid grid-cols-8 border-b py-2">
              ...
              <div className="col-span-7">
                <div className="flex">
                  <p className="mr-4 font-bold">{tweet.user.name}</p>
                ...
                <div className="grid grid-cols-4">
                  ...
                  <div className="col-span-1 flex">
                    <button
                      disabled={tweet.favorited_by}
                      onClick={(e) => submitFavorite(e, tweet.id)}
                    >
                      <svg
                        viewBox="0 0 24 24"
                        aria-hidden="true"
                        className="h-5 w-5"
                        fill={tweet.favorited_by ? "red" : "false"}
                      >
                        <g>
                    ...
                    {tweet.favorite_count !== 0 && (
                      <p className="px-1 text-sm">{tweet.favorite_count}</p>
                    )}
                  </div>
                  <div className="col-span-1 flex">
                    <button onClick={(e) => submitBookmark(e, tweet)}>
                      <svg
                        viewBox="0 0 24 24"
                        className="h-5 w-5"
                        aria-hidden="true"
                        fill={tweet.bookmarked_by ? "blue" : "false"}
                      >
                        <g>
